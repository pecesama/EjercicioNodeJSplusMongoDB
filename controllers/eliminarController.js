var eliminarController = function(Contacto) {

    var post = function(req, res) {
        var contacto = new Contacto(req.body);//Creamos un esquema contacto que contiene el cuerpo de nuestra petición.

        Contacto.deleteOne(contacto.id, function(err) {//utilizamos la función save para guardar nuestro esquema de contacto en la base de datos.
...
module.exports = eliminarController;
